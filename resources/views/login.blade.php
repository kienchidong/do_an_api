...
addEventListener("load", function () {
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('login/images/logo-kien.png') }}" />
    <!-- //Meta-Tags -->
    <!-- Index-Page-CSS -->
    ...
    <link rel="stylesheet" href="{{ asset('login/css/font-awesome.css') }}" type="text/css" media="all">
</head>
...
<div class="content-w3ls">
    <div class="content-top-agile">
        <a target="_blank" href="{{ url('') }}"><img src="{{ asset('login/images/logo-kien.png') }}" alt="" width="40%"></a>
    </div>
...
<div class="copyright text-center">
    <p>© 2018 Copy right
        <a target="_blank" href="">Hà Đức Kiên</a>
    </p>
</div>
</body>
<!-- //Body -->
