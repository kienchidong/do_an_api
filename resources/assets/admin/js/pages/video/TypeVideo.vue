    ...
    export default {
        ...
        methods:{
            firstLoad() {
                ...
                axios.post('typeVideo/getList', this.formLoad).then(response => {
                    ...
                    if (response.data.data.lists.length > 0) {
                        ...
                        this.table.isNull = 'không có loại video';
                    }
                }).catch(err => {
                    console.log(err)
                })
            ...
            submitCate() {
                ...
                if (this.formData.id === null) {
                    type = 'typeVideo/store';
                } else {
                    type = 'typeVideo/edit/' + this.formData.id;
                }
            ...
            DeleteCate(index) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        axios.post('typeVideo/delete/' + obj.id).then(response => {
                            this.firstLoad();
                        }).catch(err => {
                            const {data} = err.response;
                            alert(data.message);
